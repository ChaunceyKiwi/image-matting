...
Used to calculate the value of laplacian matrix. 
\subsection{SparseMatrixEquationSolver}
Used to solved the equation of large scale sparse matrix.
\subsection{AlphaCalculator}
Alpha calculator will firstly use Laplacian calculator to get laplacian matrix. Then form the sparse matrix equation and use sparse matrix equation solver to solve it and get alpha.
